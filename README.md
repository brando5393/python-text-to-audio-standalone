...
| `TextExtraction.py` | Pulls plain text out of txt/md/pdf/epub/mobi/azw3/docx/rtf/html, reads page/chapter counts for display, and (for EPUB/DOCX/MOBI/AZW3) splits a document into per-chapter text for the "Split into chapter files" option |
